...
cEditorToolbarUI::cEditorToolbarUI(sf::RenderWindow* window, DrawTool& _DrawTool, sf::RenderTexture* _canvasTexture)
...
void cEditorToolbarUI::UpdateLineThicknessUIOrigin()
{
